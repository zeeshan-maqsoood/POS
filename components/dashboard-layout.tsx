...
//         icon: ShoppingCart,
//       },
//       { name: "orders", href: "/dashboard/orders", icon: Sparkles },
...
//                           key={item.name}
//                           href={item.href}
//                           className={`group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg mx-2 ${
...
//                               pathname.startsWith(item.href) ? 'text-gray-700' : 'text-gray-400 group-hover:text-gray-500'
//                             }`}
//                             aria-hidden="true"
//                           />
//                           {item.name}
